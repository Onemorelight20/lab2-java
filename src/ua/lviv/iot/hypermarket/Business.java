...
public class Business {
    public static void main(String[] args) {
        ...
        System.out.println("All items: " + hypermarket.getItems());

        List<Category> specificCategories = List.of(Category.FURNITURE, Category.PLUMBING);
        List<Item> furnitureAndPlumbingItems = itemManager.findByCategories(specificCategories);
        System.out.println("Furniture and plumbing items: " + furnitureAndPlumbingItems);

    }

    private static List<Item> generateListOfPaint() {
    ...
    private static List<Item> generateListOfSinks() {
    ...
    private static List<Item> generateListOfDoors() {
